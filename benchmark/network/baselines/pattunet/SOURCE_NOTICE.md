# PAttUNet baseline source

Adapted from:

<https://github.com/faresbougourzi/PDAtt-Unet>

Upstream model file (class `PAttUNet`, plus the `DoubleConv` and
...
ignores it for this architecture). No layer or forward computation was
modified.
