...
try:
    ...
    raise ImportError("CCViM requires timm and einops before importing its upstream model") from exc
# from fvcore.nn import FlopCountAnalysis, flop_count_str, flop_count, parameter_count
from .multi_mamba_upstream import MultiScan
...
try:
    ...
    try:
        ...
        raise ImportError(
            "CCViM needs selective_scan_cuda or selective_scan_vmamba_pt202; "
            "install a compatible CUDA selective-scan extension."
        ) from exc
