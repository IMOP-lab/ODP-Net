...
try:
    ...
    raise ImportError("VMamba requires timm and einops before importing its upstream model") from exc
try:
...
try:
    from .csm_triton_upstream import cross_scan_fn, cross_merge_fn
except:
    from .csm_triton_upstream import cross_scan_fn, cross_merge_fn

try:
    from .csms6s_upstream import selective_scan_fn, selective_scan_flop_jit
except:
    from .csms6s_upstream import selective_scan_fn, selective_scan_flop_jit
